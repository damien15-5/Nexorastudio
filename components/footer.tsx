      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-sm">
              Premium B2B web design agency building high-impact digital
              experiences for modern businesses. Fast, secure, and
              conversion-focused.
            </p>
            <a
              href="https://wa.me/2349035623261"
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-500/10 text-green-500 rounded-lg text-sm font-medium hover:bg-green-500/20 transition-colors"
            >
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Nexora Studio. All rights
            reserved.
          </p>
